...
use crate::resources::{
    Account, Address, Application, ApplicationFee, BalanceTransaction, BillingDetails, CardPresent,
    ChargeSourceParams, Currency, Customer, FraudDetailsReport, Invoice, Mandate, Order,
    PaymentIntent, PaymentMethod, PaymentMethodDetailsCardInstallmentsPlan, Refund, Review,
    Shipping, ThreeDSecure, Transfer,
};
...
pub struct Charge {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payment_method_details: Option<Details>,
